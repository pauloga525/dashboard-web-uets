    ...
    <div class="p-6">
      ...
      <div class="space-y-4 animate-[fadeIn_.2s_ease_forwards]">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label class="block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1">URL del logo</label>
            <input [(ngModel)]="config.logoUrl" (ngModelChange)="onChange()" placeholder="/logo.png" class="input-field" /></div>
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-2">
            <input [(ngModel)]="r.icon" (ngModelChange)="onChange()" placeholder="Ícono material (ej: public)" class="w-36 input-field text-xs" />
            <input [(ngModel)]="r.label" (ngModelChange)="onChange()" placeholder="Nombre" class="w-28 input-field text-sm" />
            <input [(ngModel)]="r.href" (ngModelChange)="onChange()" placeholder="URL" class="flex-1 input-field text-sm" />
      ...
      <div class="space-y-4 animate-[fadeIn_.2s_ease_forwards]">
        ...
        <hr class="border-slate-100 dark:border-slate-800" />
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><label class="block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1">URL imagen del mapa</label>
            <input [(ngModel)]="config.mapaImagen" (ngModelChange)="onChange()" placeholder="https://..." class="input-field" /></div>
